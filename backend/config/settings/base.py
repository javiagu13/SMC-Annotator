...
CSRF_TRUSTED_ORIGINS = env.list("CSRF_TRUSTED_ORIGINS", ["http://127.0.0.1:3000","http://127.0.0.1:8000","http://192.168.182.1:3000", "http://0.0.0.0:3000", "http://localhost:3000"])
...
if DEBUG:
    ...
    CSRF_TRUSTED_ORIGINS = ["http://192.168.182.1:3000","http://127.0.0.1:3000","http://127.0.0.1:8000","http://192.168.182.1:3000" "http://0.0.0.0:3000", "http://localhost:3000"]
    CSRF_TRUSTED_ORIGINS += env.list("CSRF_TRUSTED_ORIGINS", [" http://192.168.182.1:3000","http://127.0.0.1:3000","http://127.0.0.1:8000","http://192.168.182.1:3000", "http://0.0.0.0:3000", "http://localhost:3000"])
